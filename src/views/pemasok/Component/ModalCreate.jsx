      ...
      <form onSubmit={storeData}>
        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <div className="mb-2">
            ...
            <input type="text" name="nama_pemasok" id="nama_pemasok" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.nama_pemasok ? 'border-red-500' : 'border-indigo-500'}`} />
          ...
          <div className="mb-2">
            ...
            <input type="text" name="kota" id="kota" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.kota ? 'border-red-500' : 'border-indigo-500'}`} />
