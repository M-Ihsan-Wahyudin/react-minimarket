...
const ModalCreate = forwardRef((props, ref) => {
  ...
  const storeData = (e) => {
    ...
    axios({
      method: 'POST',
      baseURL: `http://127.0.0.1:8000/api/supplier/${id}`,
      data: formData,
      headers: {
      ...
      <form onSubmit={storeData}>
        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <div className="mb-2">
            ...
            <input type="text" name="nama_barang" id="nama_barang" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.nama_barang ? 'border-red-500' : 'border-indigo-500'}`} defaultValue={dataForm.nama_barang} />
          ...
          <div className="mb-2">
            ...
            <select name="nama_produk" id="nama_produk" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.nama_produk ? 'border-red-500' : 'border-indigo-500'}`} defaultValue={dataForm.nama_produk}>
              {
                category.map(item => {
                  return (
          ...
          <div className="mb-2">
            ...
            <input type="text" name="harga_jual" id="harga_jual" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.harga_jual ? 'border-red-500' : 'border-indigo-500'}`} defaultValue={dataForm.harga_jual}/>
          ...
          <div className="mb-2">
            ...
            <input type="text" name="satuan" id="satuan" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.satuan ? 'border-red-500' : 'border-indigo-500'}`} defaultValue={dataForm.satuan}/>
