...
const ModalUpdate = forwardRef((props, ref) => {
  ...
  const storeData = (e) => {
    ...
    axios({
      method: 'POST',
      baseURL: `https://backend-minimarket.herokuapp.com/api/category/${id}`,
      data: formData,
      headers: {
  ...
  useImperativeHandle(ref, () => ({
    setOpenModal(boolean, id) {
      const selectedData = category.find(x => x.id === id)
      ...
      <form onSubmit={storeData}>
        ...
        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          ...
          <div className="mb-2">
            ...
            <input type="text" name="nama_produk" id="nama_produk" className={`w-full px-3 py-2 border rounded-md focus:outline-none ${errorForm.nama_produk ? 'border-red-500' : 'border-indigo-500'}`} defaultValue={dataForm.nama_produk} />
